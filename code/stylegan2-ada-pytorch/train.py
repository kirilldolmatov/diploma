...
def setup_training_loop_kwargs(
    ...
    augpipe_specs = {
        'kirill': dict(xflip=1, rotate90=1, rotate=1),
...
def subprocess_fn(rank, args, temp_dir):
    ...
    if rank == 0:
        # wandb
        wandb_run = wandb.init(project="stylegan2-embryo")
...
@click.option('--augpipe', help='Augmentation pipeline [default: bgc]', type=click.Choice(['kirill', 'blit', 'geom', 'color', 'filter', 'noise', 'cutout', 'bg', 'bgc', 'bgcf', 'bgcfn', 'bgcfnc']))
